...
|---|---|---|
| Architecture | [ARCHITECTURE.md](../ARCHITECTURE.md) | Telemetry contracts, correlation and exporter boundaries and system boundaries |
...
| Contracts | [tests/test_foundation.py](../tests/test_foundation.py) | Contract-focused validation at the repository boundary |
