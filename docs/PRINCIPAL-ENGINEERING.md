...
## Core boundary
**Primary concern:** Observability.

Telemetry contracts remain independent of exporters; correlation context is propagated; health, metrics, logs, and traces are distinct; observability failures do not silently change domain outcomes.
...
- **Operability:** health/readiness signals and structured correlation context support diagnosis without requiring raw sensitive payloads.
