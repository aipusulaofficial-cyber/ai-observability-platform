...
Define telemetry contracts independently of exporters; propagate correlation context; distinguish health, metrics, logs, and traces; avoid observability code changing domain outcomes; test failure-path telemetry.
