...
Check exporter health, queue/drop counters, aggregation latency, cardinality, and correlation IDs. Prefer preserving service availability over blocking on telemetry exporters.